"""Shared logging setup for the users microservice.
...
Logz.io UI. Copied from the blob/load-balancer services so this project is
self-contained.
"""
...
DEFAULT_LOGZIO_SERVICE = "users-service"
