"""Shared logging setup for the analytics (page-views) service.
...
Logz.io UI. Copied from the users service so this project is self-contained.
"""
...
DEFAULT_LOGZIO_SERVICE = "analytics-service"
